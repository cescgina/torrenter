...
class TrackerResponseTest(unittest.TestCase):
    def setUp(self):
        self.ok_response = OrderedDict([(b"complete", 5500), 
                                        (b"incomplete", 240), 
                                        (b"interval", 1800),
    ...
    def test_succesful_response_no_failure(self):
    ...
    def test_response_interval(self):
        response = TrackerResponse(self.ok_response)
        self.assertEqual(1800, response.interval)

    def test_response_peer_string(self):
        response = TrackerResponse(self.ok_response)
